...
%% plot raw data
hfig      = plot_data_time_domain(data,params,'Raw Data','Time (sec)','mini-volts?');
...
hfig      = plot_data_time_domain(data_trim,params,'Trimmed Raw Data','Time (sec)','mini-volts?');
save_figure(hfig,['01_',settings.patientid],settings.figout,settings.figformat); 

hfig      = plot_data_freq_domain(data_trim,params,'PSD of trimmed data');
...
hfig      = plot_data_freq_domain(filt_data,params,'High passed + DC offset');
