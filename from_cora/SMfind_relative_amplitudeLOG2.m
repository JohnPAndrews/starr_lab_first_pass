...
function [amp width] = SMfind_relative_amplitudeLOG2(psd_data, f)
...
if (sigma2 < 0)
    if (flag == 0)
        [amp width] = SMfind_relative_amplitudeLOG2(psd_data, f, 1, ff(mymax_ind)); %try recalculating to find different beta peak
        return
    else
