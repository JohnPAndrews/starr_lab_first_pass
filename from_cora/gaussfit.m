...
% from http://www.mathworks.com/matlabcentral/fileexchange/35122-gaussian-fit/content//gaussfit.m

%modified to export value s so that appropriate multiplication constant can be calculated

function [sigma, mu, s] = gaussfit( x, y, sigma0, mu0 )
