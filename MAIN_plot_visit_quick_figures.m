...
[pn,fn,ext] = fileparts(datadir);
load(fullfile(datadir,'dataBR.mat'));
logclean = strcmp(datTab.task,'rest') | strcmp(datTab.task,'ipad')  | ...
    strcmp(datTab.task,'walking')  | strcmp(datTab.task,'home-recording') ;
totalfiles = sum(logclean);
cntcln = 1; 
for s = 1:size(datTab,1)
    data =  [datTab.lfp{s}'; datTab.ecog{s}'];
    logclean =  strcmp(datTab.task{s},'rest') | ...
                strcmp(datTab.task{s},'ipad')  | ...
                strcmp(datTab.task{s},'walking') | ...
                strcmp(datTab.task{s},'home-recording') |... 
                strcmp(datTab.task{s},'other') |...
                strcmp(datTab.task{s},'montage');
    if logclean
